...
import exchange_api.injective_insurance_rpc_pb2 as injective__insurance__rpc__pb2
...
class InjectiveInsuranceRPCStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Funds = channel.unary_unary(
                ...
                request_serializer=injective__insurance__rpc__pb2.FundsRequest.SerializeToString,
                response_deserializer=injective__insurance__rpc__pb2.FundsResponse.FromString,
                )
        self.Redemptions = channel.unary_unary(
                '/injective_insurance_rpc.InjectiveInsuranceRPC/Redemptions',
                request_serializer=injective__insurance__rpc__pb2.RedemptionsRequest.SerializeToString,
                response_deserializer=injective__insurance__rpc__pb2.RedemptionsResponse.FromString,
                )
...
def add_InjectiveInsuranceRPCServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Funds': grpc.unary_unary_rpc_method_handler(
                    servicer.Funds,
                    request_deserializer=injective__insurance__rpc__pb2.FundsRequest.FromString,
                    response_serializer=injective__insurance__rpc__pb2.FundsResponse.SerializeToString,
            ),
            'Redemptions': grpc.unary_unary_rpc_method_handler(
                    servicer.Redemptions,
                    request_deserializer=injective__insurance__rpc__pb2.RedemptionsRequest.FromString,
                    response_serializer=injective__insurance__rpc__pb2.RedemptionsResponse.SerializeToString,
            ),
    }
...
class InjectiveInsuranceRPC(object):
    ...
    def Funds(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/injective_insurance_rpc.InjectiveInsuranceRPC/Funds',
            injective__insurance__rpc__pb2.FundsRequest.SerializeToString,
            injective__insurance__rpc__pb2.FundsResponse.FromString,
    ...
    def Redemptions(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/injective_insurance_rpc.InjectiveInsuranceRPC/Redemptions',
            injective__insurance__rpc__pb2.RedemptionsRequest.SerializeToString,
            injective__insurance__rpc__pb2.RedemptionsResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
